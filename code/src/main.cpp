...
pros::MotorGroup leftMotors({1, 2}, pros::MotorGearset::blue); // right motor group - ports 6, 7, 9 (reversed)
...
lemlib::ControllerSettings linearController(10, // proportional gain (kP)
                                            ...
                                            40000, // large error range timeout, in milliseconds
